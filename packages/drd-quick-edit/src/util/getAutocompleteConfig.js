...
export const CREATE_NEW_DECISION = 'Create new Decision Table';
export const CREATE_NEW_INPUT_DATA = 'Create new Input Data';

export function getAutocompleteConfig(options) {
